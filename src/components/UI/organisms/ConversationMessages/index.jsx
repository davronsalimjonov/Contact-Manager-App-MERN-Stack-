...
//     },
//     {
//         "id": "01de15e0-e48b-446f-adcf-66f568e9104f",
//         "createdAt": "2024-11-20T09:44:21.805Z",
//         "type": "comment",
//         "isViewed": true,
//         "call": null,
...
//         "sms": null
//     },
// ].filter(msg => ['message', 'call', 'comment'].includes(msg.type))
...
const ConversationMessages = ({
    ...
    const RenderMessage = (message, index) => {
        switch (message?.type) {
            case 'message': return (
                <div key={message?.id} className={cls.chat__row} style={{paddingTop: index === 0 ? '20px' : ''}}>
                    <ChatTextMessage
